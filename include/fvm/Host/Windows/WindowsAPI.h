#ifndef WINDOWSAPI_H_
#define WINDOWSAPI_H_
...
extern BOOL winapi_console_reset();
extern BOOL winapi_console_setAttr(WORD c);
extern WORD winapi_console_getAttr();
extern WORD winapi_console_getDefaultAttr();
extern BOOL winapi_console_print(std::ostream & os, std::string str, int console_attr);
extern BOOL winapi_console_print(std::ostream & os, std::string str);
